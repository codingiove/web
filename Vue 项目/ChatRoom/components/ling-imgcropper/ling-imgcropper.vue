<template>
  ...
  >
    ...
    <view class="btn-group">
      <!--  #ifdef MP-ALIPAY -->
      <view class="btn-item iconfont" v-show="showResetBtn" @tap="init"
        >&#xe622;</view
      >
      <view
...
@font-face {
  ...
  src: url("https://at.alicdn.com/t/font_997741_k4k7vblf4i.eot?#iefix")
    ...
    url("https://at.alicdn.com/t/font_997741_k4k7vblf4i.svg#iconfont")
      format("svg");
}
.vue-cropper {
  position: fixed;
